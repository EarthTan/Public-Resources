...
class SelectionManager {
    ...
    generateLaTeXResume() {
        ...
        const personalInfo = latexBuilder.getPersonalInfo();
        const organizedContent = latexBuilder.organizeContentByCategory(this.selectedItems);
        const latexContent = latexBuilder.generateLaTeXDocument(personalInfo, organizedContent);
        const blob = fileUtils.createTextBlob(latexContent, 'text/plain');
